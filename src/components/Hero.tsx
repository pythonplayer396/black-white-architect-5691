    ...
    <section className="relative h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute top-28 left-0 right-0 z-10">
        <div className="container mx-auto px-8">
          <div className="flex items-center gap-4 text-background/70 reveal">
      ...
      <div className="relative z-10 container mx-auto px-8">
        <div className="max-w-5xl">
          <h1 className="text-architectural text-background text-[3.5rem] md:text-[6rem] lg:text-[7.5rem] reveal">
            Considered software,
            <br />
          ...
          <div className="mt-12 grid md:grid-cols-12 gap-8 reveal-delayed">
            ...
            <p className="md:col-span-7 text-lg md:text-xl text-background/75 font-light leading-relaxed max-w-2xl">
      ...
      <div className="absolute bottom-10 left-0 right-0 z-10">
        <div className="container mx-auto px-8 flex items-end justify-between text-background/60 reveal-delayed">

const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden bg-background paper-texture pt-32 pb-20">
      {/* Top eyebrow rail */}
      ...
      <div className="relative z-10 container mx-auto px-8">
        <div className="max-w-5xl">
          <h1 className="text-architectural text-foreground text-[3.5rem] md:text-[6rem] lg:text-[7.5rem] reveal">
            Considered software,
            <br />
          ...
          <div className="mt-12 grid md:grid-cols-12 gap-8 reveal-delayed">
            ...
            <p className="md:col-span-7 text-lg md:text-xl text-muted-foreground font-light leading-relaxed max-w-2xl">
